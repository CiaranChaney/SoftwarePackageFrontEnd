                ...
                <div className={"row"}>
                    <div className={"col-lg-8 offset-lg-2"}>
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Website</strong> refers to Hash Veritas, accessible from <a
                                    href="https://www.hashveritas.com/"
                                    rel="external nofollow noopener"
                                    target="_blank">https://www.hashveritas.com/</a>
                                </p>
                            </li>
                            <li>
                        ...
                        <p>While using Our Service, We may ask You to provide Us with certain personally identifiable
                            ...
                            be used to contact or identify You. Personally identifiable information may include, but is
                            not limited to:</p>
                        <ul>
                            <li>
                                <p>Email address</p>
                        ...
                        <p>You may update, amend, or delete Your information at any time by signing in to Your Account,
                            ...
                            Us to request access to, correct, or delete any personal information that You have provided
                            to Us.</p>
                        ...
                        <ul>
                            <li>By email: admin@hashveritas.com</li>
                        </ul>
